  ...
  <div class="mx-auto my-6 h-auto max-w-sm p-5 rounded-lg shadow bg-[#073763] border-[#0c343d] border-4 flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="<?= urlpath('login'); ?>" method="POST">
        ...
        <div>
          <button type="submit" class="flex w-full justify-center rounded-md bg-[#0b5394] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#3d85c6]">Login</button>
        </div>
      </form>
  
      <p class="mt-10 text-center text-sm text-white">Not a member?
        <a href="<?= urlpath('register'); ?>" class="font-semibold leading-6 text-[#3d85c6] hover:text-[#6fa8dc] hover:underline">Sign Up</a>
      </p>
    </div>
  </div>
</section>